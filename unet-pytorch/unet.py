...
#--------------------------------------------#
#   To use your own trained model, modify 2 parameters:
...
class Unet(object):
    _defaults = {
        #-------------------------------------------------------------------#
        #   model_path points to weight file in logs folder
        #   After training, multiple weight files exist in logs folder - choose one with lower validation loss
        #   Lower validation loss doesn't mean higher mIoU, just better generalization on validation set
        #-------------------------------------------------------------------#
        "model_path"    : r'unet-pytorch\logs\ep035-loss1.181-val_loss1.217.pth',
        #--------------------------------#
        ...
        "input_shape"   : [672, 672],
        #-------------------------------------------------#
        #   mix_type controls visualization of detection results:
        #
        #   mix_type = 0: Blend original image with generated image
        #   mix_type = 1: Keep only generated image
        #   mix_type = 2: Remove background, keep only targets from original image
        #-------------------------------------------------#
        "mix_type"      : 1,
        #--------------------------------#
        #   Whether to use CUDA
    ...
    def detect_image(self, image, count=False, name_classes=None):
        ...
        #   Only RGB images supported - others will be converted
        #---------------------------------------------------------#
        image       = cvtColor(image)
        #---------------------------------------------------#
        #   Make copy of input image for later drawing
        #---------------------------------------------------#
...
class Unet_ONNX(object):
    _defaults = {
        #--------------------------------------------------------------------------#
        #   onnx_path points to onnx weight file in model_data folder
        #-------------------------------------------------------------------#
