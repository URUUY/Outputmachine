...
class Bottleneck(nn.Module):
    """Bottleneck residual block for deeper ResNets (50, 101, 152)"""
    expansion = 4
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        # Use 3x3 convolution for feature extraction
        self.conv2 = conv3x3(width, width, stride, groups, dilation)
        self.bn2 = norm_layer(width)
        # Use 1x1 convolution to expand channels
...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes=1000):
        #-----------------------------------------------------------#
        #   Assuming input image size is 600x600x3
        #   When using resnet50:
        #-----------------------------------------------------------#
        self.inplanes = 64
    ...
    def forward(self, x):
        # Original classification forward pass (commented out)
        # x = self.conv1(x)
        # x = self.bn1(x)
        # x = self.relu(x)
        # x = self.maxpool(x)
